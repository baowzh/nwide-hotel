            ...
            if (bCheck == true) {
                ...
                if (zuheDate.length > 0) {
                    ...
                    $.each(zuheDate, function (index, item) {
                        ...
                        var tr = $("<tr></tr>");
                        tr.appendTo(tbody); 
						var tit = '';var length=td_array.length
						...
						var td1 = $("<td ><input style=\"border: 1px solid #ccc; \" name=\"prices[]\" class=\"l-text\" type=\"text\" value="+ price +"></td><input name=\"titles[]\" class=\"l-text\" type=\"hidden\" value="+ tit +">");
                        td1.appendTo(tr);
                        var td2 = $("<td ><input style=\"border: 1px solid #ccc; \" name=\"nums[]\" class=\"l-text\" type=\"text\" value="+ num +"></td>");
                        td2.appendTo(tr);
